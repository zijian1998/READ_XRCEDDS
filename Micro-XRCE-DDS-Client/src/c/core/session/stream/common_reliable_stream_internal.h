...
// buffer = stream.buffer + seq_num%stream.history*(stream.size/stream.history)+uint32在当前环境的字节数
...
// buffer_capacity = stream.size/stream.history - uint32在当前环境的字节数
