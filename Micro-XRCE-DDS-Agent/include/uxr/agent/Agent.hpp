...
public:
     ...
     *  create操作两个标志位：reuse、replace，决定了采取什么操作  基于DDS-XRCE标准
     ...
     * 8种object participant、topic、publisher、subscriber、datawriter、datareader、requester、replier
     */
     ...
     * @param client_key        The identifier of the ProxyClient.      // 客户端的代理
     * @param participant_id    The identifier of the Participant to be created.        // 参与者id
     * @param domain_id         The domain associated with the Participant.     // 参与者关联的域id
     * @param ref               The reference of the Participant.                       // 描述
     * @param flag              The flag that determines the creation mode.     // 创建模式的标志
     * @param op_result         The result status of the operation.             // 结果
     * @return  true in case of success and false in other case.
     */
