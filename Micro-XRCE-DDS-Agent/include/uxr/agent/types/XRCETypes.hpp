...
public:
    ...
    /*!
     * @brief Move constructor. 右值移动为左值
     * @param x Reference to the object CreationMode that will be copied.
     */
    CreationMode(CreationMode &&x);
    
    /*!
     * @brief Copy assignment. 赋值重载
     * @param x Reference to the object CreationMode that will be copied.
     */
    CreationMode& operator=(const CreationMode &x);
    
    /*!
     * @brief Move assignment. 右值移动为左值的重载
     * @param x Reference to the object CreationMode that will be copied.
     */
    CreationMode& operator=(CreationMode &&x);
    
    /*!
     * @brief This function sets a value in member reuse 设置成员reuse值
    ...
    /*!
     * @brief This function returns the value of member reuse 返回成员reuse的值
    ...
    /*!
     * @brief This function returns a reference to member reuse 返回成员reuse的一个引用
